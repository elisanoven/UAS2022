          ...
          @csrf
            ...
            <div class="form-group w-25">
               ...
               <select name="jurusan" class="form-control">
                   ...
                   <option value="Arsitel">Arsitek</option>
                   <option value="Design Produk">Design Produk</option>
            ...
            <div class="form-group w-25">
                <input type="checkbox" name="bidang_minat[]" value="Seni_Rupa" class="form-check-input">
                <label>Seni Rupa</label>
            </div>
            <div class="form-group w-25">
                <input type="checkbox" name="bidang_minat[]" value="Gapala" class="form-check-input">
                <label>Gapala</label>
            </div>
            <div class="form-group w-25">
                <input type="checkbox" name="bidang_minat[]" value="Paduan_Suara" class="form-check-input">
                <label>Paduan Suara</label>
            </div>
            <div class="form-group w-25">
                <input type="checkbox" name="bidang_minat[]" value="photographi" class="form-check-input">
                <label>Photographi</label>
            </div>
            <div class="form-group w-25">
                <input type="checkbox" name="bidang_minat[]" value="Cinematographi" class="form-check-input">
