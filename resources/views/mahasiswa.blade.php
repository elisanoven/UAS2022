...
<html lang="en">
  ...
  <div class="container=fluid">
        <div class="row">
            <div class="col-lg-12 text-white bg-dark py-2">
...
<div class="container-fluid">
  <div class="row">
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          ...
          <li class="nav-item">
            <a class="nav-link" href="/isialternatif">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4"><div class="chartjs-size-monitor">
      ...
      <canvas class="my-4 w-100 chartjs-render-monitor" id="myChart" width="109" height="46" style="display: block; width: 109px; height: 46px;"></canvas>
       <div class="card-body">
              @if(session('alert'))
      ...
      <div>
      <a name="" id="" class="btn btn-primary" href="/mahasiswa/formmahasiswa" role="button"><i class="bi bi-file-plus"></i>ADD Mahasiswa</a>
</div>
      ...
      <div class="table-responsive">
        <table class="table table-striped table-sm">
          ...
          @foreach ($mahasiswa as $no => $m)
            <tr>
            <th scope="row"><?php echo ++$no +($mahasiswa->currentPage()-1)*$mahasiswa->perPage()?></th>
            <td>{{$m -> nim}}</td>
            <td>{{ $m -> nama }}</td>
            <td>{{ $m -> gender }}</td>
            <td>{{ $m -> jurusan }}</td>
            ...
            <td>
                <a href="/mahasiswa/editmahasiswa/{{ $m -> id }}" class="btn btn-outline-success"><i class="bi bi-pencil-square"></i></a>
                <a href="/mahasiswa/deletemahasiswa/{{ $m -> id }}" class="btn btn-outline-danger"><i class="bi bi-x-square"></i></a>
      </td>
            </tr>
            @endforeach
            </tbody>
        </table>
        Jumlah Data : <?php echo $mahasiswa->count() ?>
...
<script src="dashboard.js"></script>
    <!--div class="container=fluid">
        ...
        <div class="row">
            ...
            <a class="nav-link active" href="/menu" >Dashboard</a>
            <a class="nav-link"href="/datakriteria" >Data Kriteria</a>
            <a class="nav-link"href="/dataalternatif" >Data Alternatif</a>
            <a class="nav-link"href="/isialternatif" >Isi Alternatif</a>
            <a class="nav-link"href="/hasilseleksi" >Hasil Seleksi</a>
