...
<div class="container-fluid">
  <div class="row">
    ...
    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4"><div class="chartjs-size-monitor">
      ...
      <div>
      <a name="" id="" class="btn btn-primary" href="/user/formuser" role="button"><i class="bi bi-file-plus"></i>ADD User</a>
</div>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
        ...
        <a href="/user/deleteuser/ {{ $u -> id }}" class="btn btn-outline-danger"><i class="bi bi-x-circle"></i></a>
      </td>
    </tr>
    @endforeach
  </tbody>
</table>
Jumlah Data : <?php echo $user->count() ?>
